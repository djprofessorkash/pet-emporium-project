        ...
        try:
            ...
            if any(method in methods for method in UNAUTHORIZED_METHODS):
                ...
                if not authorized_user.is_administrator():
                    ...
                    return make_response({"error": "Insufficient permissions. Administrative access is required to progress through this part of the application."}, 401)
        except Exception as error:
            return make_response({"error": "Something went wrong.", "details": str(error)}, 500)
